          ...
          <div class="card-body pb-0">
            ...
            <div class="form-group">
              ...
              <select name="petugas" id="petugas_name" class="form-control select2-ajax"
                data-placeholder="Pilih Petugas Screening" data-url="{{ route('ajax.petugas') }}">
                @if ($data->petugas && @$data->petugas->id)
                <option value="{{ $data->petugas->id }}">{{ $data->petugas->name }}</option>
                @endif
              </select>
            </div>
          </div>
